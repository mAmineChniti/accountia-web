  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6 px-4 py-10 sm:px-6 lg:px-8 print:p-0">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card className="dark:bg-card/90 border-0 border-l-4 border-l-green-500 bg-white/90 shadow-sm transition-all hover:shadow-md">
        ...
        <Card className="dark:bg-card/90 border-0 border-l-4 border-l-red-500 bg-white/90 shadow-sm transition-all hover:shadow-md">
          <CardHeader className="pb-2">
            <CardDescription className="flex items-center gap-2">
        ...
        <Card className="dark:bg-card/90 border-l-primary border-0 border-l-4 bg-white/90 shadow-sm transition-all hover:shadow-md">
          <CardHeader className="pb-2">
            <CardDescription className="flex items-center gap-2">
      ...
      {/* Print Footer */}
      <div className="text-muted-foreground mt-20 hidden border-t pt-10 text-center text-xs print:block">
        Generated by Accountia Financial Reporting System on{' '}
